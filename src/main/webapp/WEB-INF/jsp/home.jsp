						...
						<li class="dropdown user user-menu"><a href="#"
							...
							<ul class="dropdown-menu">
								...
								<li class="user-footer">
									<div class="pull-left">
										<a href="edit" class="btn btn-default btn-flat">Edit Profile</a>
									</div>
		...
		<aside class="main-sidebar">
			...
			<section class="sidebar" style="height: auto;">
				...
				<ul class="sidebar-menu tree" data-widget="tree">
					...
					<li class=""><a href="teacherGraph"> <i class="fa fa-user"></i>
							<span>Places</span>
					</a></li>
						<li class=""><a href=""> <i class="fa fa-user"></i>
							<span>Contact us</span>
					</a></li>
					<li class="fa fa-globe"><a href=""> <i class="fa fa-user"></i> <span>About us</span>
					</a></li>
				</ul>
			</section>
			<!-- /.sidebar -->
					...
					<div class="row">
						<div class="col-lg-4 col-xs-6">
							...
							<div class="small-box bg-aqua">
								<a href="addLocation" class="box-ref">
									<div class="inner">
										<h3>Add place</h3>
								...
								</a><a href="totalUserTable" class="small-box-footer">More info
						...
						<div class="col-lg-4 col-xs-6">
							...
							<div class="small-box bg-green">
								<a href="teacherGraph" class="box-ref">
									<div class="inner">
										<h3>View place</h3>
								...
								</a><a href="teacherGraph" class="small-box-footer">More
						...
						<div class="col-lg-4 col-xs-6">
							...
							<div class="small-box bg-yellow">
								...
								</a><a href="" class="small-box-footer">More
									info <i class="fa fa-arrow-circle-right"></i>
								</a>
				...
				<form method="post" id="modalFooter" action="">
					...
					<div class="modal-content">
						<div class="modal-header">
							...
							<input id="deleteData1" name="deleteData1" type="hidden" value="">
							<input id="deleteData2" name="deleteData2" type="hidden" value="">
							<input id="deleteData3" name="deleteData3" type="hidden" value="">
							<input id="deleteData4" name="deleteData4" type="hidden" value="">
						</div>
...
<script src="resources/js/bar1.js"></script>

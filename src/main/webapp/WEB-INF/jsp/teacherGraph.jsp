...
<table>
			...
			<tbody>
				<c:forEach items="${totalCategoryTable}" var="totalCategoryTable">
					<tr>
						<td><img src="/resources/uploads/12.jpg"
							class="img-thumbnail" width="200" height="300"></td>
						<td>
							<ul>
								<li><label>Id </label>:${totalCategoryTable.id}</li>
								<li><label>Name</label> : ${totalCategoryTable.name}</li>
								<li><label>Email</label> : ${totatotalCategoryTable.email}</li>
								<li><label>Dob</label> : ${totalCategoryTable.dob}</li>
								<li><label>Role</label> : ${totalCategoryTable.role}</li>
							</ul>
						</td>
					</tr>
					<br>

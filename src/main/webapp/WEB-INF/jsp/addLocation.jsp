		...
		<aside class="main-sidebar">
			...
			<section class="sidebar" style="height: auto;">
				...
				<ul class="sidebar-menu tree" data-widget="tree">
					...
					<li class=""><a href="/studentGraph"> <i
							class="fa fa-user"></i> <span>Places</span>
					</a></li>
				
					<li class=""><a href="map"> <i class="fa fa-user"></i> <span>Contact us</span>
					</a></li>
					<li class=""><a href="addLocation"> <i class="fa fa-user"></i>
							<span>About us</span>
					</a></li>
				</ul>
			</section>

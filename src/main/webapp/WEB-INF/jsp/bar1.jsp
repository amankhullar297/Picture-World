	...
	<div class="wrapper" style="height: auto; min-height: 100%;">
		...
		<aside class="main-sidebar">
			...
			<section class="sidebar" style="height: auto;">
				...
				<ul class="sidebar-menu tree" data-widget="tree">
					...
					<li class=""><a href="adminAddLocation"> <i class="fa fa-user"></i>
					...
					<li class=""><a href="bar1"> <i class="fa fa-user"></i> <span>Add
								category</span>
					</a></li>
		...
		<div class="content-wrapper" style="min-height: 668px;">		
			...
			<form style="padding: 60px" style="background-color:#d7e5f6"
												class="common-form" method="post" action="/addCategory"
												enctype="multipart/form-data" id="sign-form">
												<div style="">
													<h3>
														<u><b>Add new Category :</b></u>
													</h3>
												</div>
												<div class="form-group" Style="width: 75%">
													<label>Category anme :</label><br> <input type="text"
												...
												<div id="save">
													<a href="adminHome"><button id="button" type="submit"

		...
		<div class="content-wrapper" style="min-height: 668px;">
			...
			<div class="container">
				<table id="example" class="table table-striped table-bordered">
					...
					<tbody>
						<c:forEach items="${totlaUserData}" var="totlaUserData">
							<tr class="info">
								<td>${totlaUserData.id}</td>
								<td>${totlaUserData.name}</td>
								<td>${totlaUserData.email}</td>
								<td>${totlaUserData.role}</td>

								<td>${totlaUserData.dob}</td>
							</tr>
						</c:forEach>
					</tbody>
				</table>
